...
// defining component with all detils like selector,templateUrl and styleUrls
@Component({
...
export class UserDataComponent implements OnInit {
  ...
  genderArray: any[] = [];
  searchData: string;
  // creating a constructor with listservice and dropdownservice as a private property
